...
<body>
	...
	<div id="site-nav">
		<div class="container sn-container">
			...
			<p class="login-info">
				<em>Hi,<a class="vip-name" href="#">${sessionScope.CURRENT_USER}<i class="iconfont sn-icon">&#xe60f;</i></a></em>
				<a href="#" target="_top">积分<span class="score count"></span></a>
				<a href="#" target="_top">消息<span id="message" class="count"></span></a>
				<a href="#">退出</a>
			</p>
	...
	<div id="header">
		<div class="container hd-container clear">
			<h1 class="hd-logo">
				<a href="index.jsp"><img width="240px" height="130px" src="img/logo.gif" title="天猫tmall.com" alt="tmall"></a>
			</h1>
	...
	<div id="content">
		...
		<div id="category">
			<div class="cg-content">
				...
				<s:iterator id="categoryItem" value="#request.categoryList" status="L">
